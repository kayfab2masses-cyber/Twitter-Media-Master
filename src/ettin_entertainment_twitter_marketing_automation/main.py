...
def replay():
    ...
    """
    try:
        EttinEntertainmentTwitterMarketingAutomationCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        EttinEntertainmentTwitterMarketingAutomationCrew().crew().test(n_iterations=int(sys.argv[1]), openai_model_name=sys.argv[2], inputs=inputs)
